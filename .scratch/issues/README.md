...
| [UI-044](UI-044-dark-palette-contrast-debt.md) | Six colour roles sit below WCAG AA, five of them only in dark (five fixed; `accent` on `card` in dark remains) | medium | open |
...
| [ARC-037](ARC-037-lint-warnings-formatter-and-ci.md) | Lint's 76 warnings, a formatter, and CI | medium | done |
